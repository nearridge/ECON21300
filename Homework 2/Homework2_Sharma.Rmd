...
It is impossible to analyze the outcome of an individual with treatment and without treatment because each individual can only be slotted into one category. 
...
ggplot(mapping = aes(x = bmi)) +
  ...
  labs(x = "Body Mass Index", y = "Count", title = "Histogram of distribution of BMI between groups") +
  theme_economist() +
...
ggplot(mapping = aes(x = age)) +
  geom_histogram(fill = "#3a89cf", color = "black", bins = 15) +
  labs(x = "Age", y = "Count", title = "Histogram of distribution of Age between groups") +
  theme_economist() +
  facet_wrap(~ treatment)
...
ggplot(mapping = aes(x = hours)) +
  geom_histogram(fill = "#3a89cf", color = "black", bins = 15) +
  labs(x = "Hours", y = "Count", title = "Histogram of distribution of Hours between groups") +
  theme_economist() +
  facet_wrap(~ treatment)
```
